...
- Eventually, integrate multiple sensors (ARU, video, image) to monitor for interactions more efficiently since a single sensor type likely will not alone capture a high quantity of data
